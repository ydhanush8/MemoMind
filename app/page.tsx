    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative pt-32 pb-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <SignedIn>
              <Link href="/dashboard" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-lg px-8 py-4 rounded-xl font-bold transition-all shadow-2xl shadow-blue-900/50">
                Go to Dashboard →
              </Link>
            </SignedIn>
          </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-slate-800/50 border-2 border-slate-700 rounded-2xl p-8">
              ...
              <SignedIn>
                <Link href="/dashboard" className="block w-full text-center bg-slate-700 hover:bg-slate-600 text-white py-3 rounded-lg font-semibold transition-all">
                  Dashboard
                </Link>
              </SignedIn>
            </div>
      ...
      <div className="relative py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <SignedIn>
            <Link href="/dashboard" className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-lg px-10 py-4 rounded-xl font-bold transition-all shadow-2xl shadow-blue-900/50 transform hover:scale-105">
              Go to Dashboard
            </Link>
          </SignedIn>
        </div>
